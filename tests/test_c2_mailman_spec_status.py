...
SPEC = Path(__file__).resolve().parents[1] / "docs" / "C2_MAILMAN_CLEARINGHOUSE_SPEC.md"


def test_experiment_status_does_not_promote_durable_readback_to_acceptance():
    text = SPEC.read_text(encoding="utf-8")

    expected_status = "**Protocol status.** Test 1 is not passed; Test 2 and Test 3 remain blocked."
